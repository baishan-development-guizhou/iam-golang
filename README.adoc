...
- `iam` 核心模块，封装了核心的业务逻辑。
- `iam-gin` 对 gin 框架的适配，包括 `handler` 与 `middleware`。

.核心模块
----
go get -u github.com/lizhongyue248/iam-golang/iam
----

.Gin 模块
----
go get -u github.com/lizhongyue248/iam-golang/iam-gin
----
